const appMenu: NavigationConfig.Menu[] = [
  ...
  // },
  {
    icon: 'mdi-account-multiple-outline', key: 'menu.users', text: 'Users', link: '/manager-user',
    items: [
      {key: 'menu.usersList', text: 'List', link: '/manager-user/list'},
      {key: 'menu.usersEdit', text: 'Edit', link: '/users/edit/1'}
    ]
  }
]
